   ...
   More usefull information about ATtiny and arduino:
    https://www.arduinoslovakia.eu/page/attiny85
     ...
     SERVO4  <--- (OC1B) A2 #D4 3 -|3 PB4   PB1 6|- 6 #D1   (MISO,OC0B,AIN1,OC1A)----> SERVO2
        ...
        SERVO2 <- (OC1B) A2 #D4 3 -|3 PB4   PB1 6|- 6 #D1   (MISO,OC0B,AIN1,OC1A)----------------|
...
const char device_description[] PROGMEM = "SEAHU SH026c 1-Wire to 2xservo                                  ";
...
typedef enum { SERVO1_ANGLE, SERVO1_SPEED, SERVO1_POWER, SERVO2_ANGLE, SERVO2_SPEED, SERVO2_POWER, LED, SAVE }; // enumerate of intem in section array for clear human read code
...
// check led status
void check_led(){
  if (sections[LED].actualValue.b==1) digitalWrite(PIN_LED, LOW); // if section led is on 
