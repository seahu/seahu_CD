...
#
# Exmaple description:
# simply set only constant color of led strips and white led strip"
# -----------------------------------------------------------------
#Type device: 1-Wire
# Family code : 0xCD
...
echo "$color" > $DEVICE/section0/actual_value  # set color RGB1

# set RGB2 led strip
color=$(color 0 255 0) # GREEN
echo "$color" > $DEVICE/section3/actual_value  # set color RGB2

# set WHITE led strip
echo "255" > $DEVICE/section3/actual_value  # set white PWM value 0=off, 255=max
