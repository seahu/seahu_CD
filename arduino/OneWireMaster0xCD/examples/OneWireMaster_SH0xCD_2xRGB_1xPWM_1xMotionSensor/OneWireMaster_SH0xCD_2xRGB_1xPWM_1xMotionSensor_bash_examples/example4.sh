...
#
# Exmaple description:
# set repeated flash between two colors of led strip (sone way can be control RGB2 or WHITE led strip)
# ------------------------------------------------------------------------------------------------------------------
#Type device: 1-Wire
# Family code : 0xCD
...
echo "-500" > $DEVICE/section1/actual_value  # set 500ms time of flash between two colors (value <0 means flash and value >0 means fluent change)
echo "10" > $DEVICE/section2/actual_value  # set 100 cycles of repeat, 0=no repeat, -1=repeat to infinity
