...
This is direcroty with linux kernal driver for w1_seahu_cd (Multisensors 1-wire device based on Open-source android library)
Normal linux drive is part of linux source code and compile with whole linux kernel.
This driver is in format for for compile separately outside of linux source code.
